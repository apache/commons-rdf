...
public interface RDFSyntax {
    ...
    static Optional<RDFSyntax> byFileExtension(final String fileExtension) {
        ...
        return w3cSyntaxes().stream().filter(t -> t.fileExtensions().contains(ext)).findAny();
    }
     ...
     * @return If {@link Optional#isPresent()}, the {@link RDFSyntax} which has a matching {@link RDFSyntax#mediaType()}, otherwise {@link Optional#empty()}
    ...
    static Optional<RDFSyntax> byMediaType(final String mediaType) {
        ...
        return w3cSyntaxes().stream().filter(t -> t.mediaTypes().contains(type)).findAny();
    }
     ...
     * </p>
     *
     * @return A set of the official RDF 1.1 {@link RDFSyntax}es.
     *
     ...
     * <p>
     * Two {@link RDFSyntax}es are considered equal if their {@link #mediaType()}s are equal when compared as lower case strings according to
    ...
    /**
     * The hash code of an RDFSyntax is equivalent to the hash code of the {@link #mediaType()} in lower case according to {@link String#toLowerCase(Locale)}
     * with the locale {@link Locale#ROOT}.
     *
     ...
     * </p>
     * <p>
     * The returned Set MUST include the value {@link #mediaType()}; this is the behavior of the default implementation.
     * </p>
     *
     ...
     * <p>
     * This is generally the title of the corresponding standard, e.g. <em>RDF 1.1 Turtle</em>.
     * </p>
     *
